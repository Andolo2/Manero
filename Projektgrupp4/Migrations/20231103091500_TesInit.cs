...
{
    /// <inheritdoc />
    public partial class TesInit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductOfferPrice = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressEntityUserEntity", x => new { x.UserAddressId, x.UsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                 ProductEntryId = table.Column<int>(type: "int", nullable: false)
                     .Annotation("SqlServer:Identity", "1, 1"),
                 ArticleNumber = table.Column<int>(type: "int", nullable: false),
                 ProductId = table.Column<int>(type: "int", nullable: false), // Updated name here
                 SizeId = table.Column<int>(type: "int", nullable: false),
                 ColorId = table.Column<int>(type: "int", nullable: false),
                 CategoryId = table.Column<int>(type: "int", nullable: false)
             },
             constraints: table =>
             {
                 table.PrimaryKey("PK_ProductItem", x => x.ProductEntryId);
                 table.ForeignKey(
                 ...
                 table.ForeignKey(
                     ...
                     onDelete: ReferentialAction.Cascade);
                 table.ForeignKey(
                     name: "FK_ProductItem_Products_ProductId", // Updated relationship name
                     column: x => x.ProductId, // Updated property name
                     principalTable: "Products",
                     principalColumn: "ArticleNumber", // Updated property name
                     onDelete: ReferentialAction.Cascade);
                 table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItem_ProductArticleNumber",
                table: "ProductItem",
